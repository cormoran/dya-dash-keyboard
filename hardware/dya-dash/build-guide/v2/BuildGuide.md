...
1. 画像のようにいい感じに FFC ケーブルを曲げます。
   ...
   - FFC ケーブルを逆側（青い樹脂が内側になる方向）に曲げてしまうと一瞬で断線してしまう箇所があるようなので注意してください。また、何度も曲げたり強く折り目をつけてしまうと断線するので注意が必要です。
   - この部分は少し改善の必要性を感じています。うまくいかなかったら遠慮なく教えてください。
...
|                                               |                                                                                                                                                                                                  |                       |                       |
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | --------------------- |
| ![](img/sensor1.jpeg) ![](img/sensor1.1.jpeg) | ![](img/sensor2.jpeg) FFC ケーブルを逆側（青い樹脂が内側になる方向）に曲げてしまうととても簡単に断線する部分があるので注意。もし断線してしまってそうだったら替えの部品を送るので教えてください。 | ![](img/sensor3.jpeg) | ![](img/sensor4.jpeg) |
