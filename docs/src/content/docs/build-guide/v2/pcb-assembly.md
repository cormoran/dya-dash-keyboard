...
梱包時の不手際でマイナス端子の曲げ加工が一部されてない部品が同梱されている場合があります。
[追加事項](/dya-dash-keyboard/build-guide/v2/notes/#電池端子の曲げ加工がされていない場合)のページを参照して、同梱のマイナス端子が曲げ加工されたものかご確認ください。
...
正常に動作していれば、LED が光ります。バッテリーモードとして動くため、先ほど PC と接続した時とは少し違う光り方をして数秒後に LED が消えます。
...
**矢印キーの取り付け（矢印キーありモデルのみ）**

右手には矢印キーが付きます。以下の手順ではんだ付けしてください。
...
1. **レンズの取り付け**
   ...
   - IC に付いていた茶透明な**保護フィルム２つを剥がします**
     - これを忘れるとトラックボールの感度が悪くなります。
   - レンズをセットします
...
| FFC 端子の黒い部分が縦の状態で FFC ケーブルを奥まで差し込む | 黒い部分を倒してロックする                 |
| ----------------------------------------------------------- | ------------------------------------------ |
